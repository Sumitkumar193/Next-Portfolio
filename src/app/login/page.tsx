...
export default function Page() {
	...
	return (
		<div className="flex gap-10 items-center justify-center h-[90vh]">
			{isMobile ? (
				<div className="sm:w-full sm:h-[70%] flex flex-col items-center justify-center">
					<div
						className={`w-full flex flex-col items-center justify-center transition-transform ease-in-out duration-1000`}
					>
						{isLogin ? (
							<>
								<LoginForm />
				...
				<div className="shadow-md overflow-hidden bg-[url(https://s3-us-west-2.amazonaws.com/s.cdpn.io/142996/sections-3.jpg)] bg-cover bg-no-repeat min-w-[55%] min-h-[70%] flex relative">
					<div
						className={`absolute flex h-full overflow-hidden transition-all ease-in-out duration-1000 items-center bg-background justify-center w-[60%] ${
					...
					<div
						className={`absolute flex h-full overflow-hidden bg-background transition-all ease-in-out duration-1000 items-center justify-center w-[60%] ${
